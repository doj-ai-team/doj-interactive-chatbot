...
def generate_legal_document(prompt, save_dir='static/generated_docs'):
    ...
    if "bail application" in prompt_lower:
        ...
        # Ask Groq to extract details into JSON for the template
        extraction_prompt = f"""
        Extract the following details from the user prompt for a Bail Application.
        If a detail is missing, invent a realistic placeholder value.
        Output MUST be pure JSON with NO markdown blocks and EXACTLY these keys:
        "COURT NAME", "COURT ADDRESS", "APPLICANT NAME", "YOUR NAME", "relation_to_applicant", "OFFENSE", "SECTION", "DATE OF INCIDENT", "CASE NUMBER", "DATE", "YOUR ADDRESS", "YOUR CONTACT"
        ...
        data = {
            "COURT NAME": extracted_data.get("COURT NAME", "District Court of New Delhi"),
            "COURT ADDRESS": extracted_data.get("COURT ADDRESS", "123 Court St, New Delhi"),
            "APPLICANT NAME": extracted_data.get("APPLICANT NAME", "Default Applicant"),
            "YOUR NAME": extracted_data.get("YOUR NAME", "Raj Singh"),
            "relation to applicant, e.g., family member, friend, legal counsel": extracted_data.get("relation_to_applicant", "legal counsel"),
            "OFFENSE": extracted_data.get("OFFENSE", "Theft"),
            "SECTION": extracted_data.get("SECTION", "379"),
            "DATE OF INCIDENT": extracted_data.get("DATE OF INCIDENT", "October 1, 2023"),
            "CASE NUMBER": extracted_data.get("CASE NUMBER", "A1234"),
            "DATE": extracted_data.get("DATE", "November 2, 2023"),
            "YOUR ADDRESS": extracted_data.get("YOUR ADDRESS", "45 Elm St, New Delhi"),
            "YOUR CONTACT": extracted_data.get("YOUR CONTACT", "+91-1234567890")
        }
